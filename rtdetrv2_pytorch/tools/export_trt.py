...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--onnx", "-i", type=str, required=True, help="Path to input ONNX model file"
    )
    parser.add_argument(
        "--saveEngine",
        "-o",
    ...
    parser.add_argument(
        ...
        type=int,
        default=16,
        help="Optimal batch size for inference",
    )
    parser.add_argument(
        "--minBatchSize",
        "-mb",
    ...
    parser.add_argument(
        "--fp16", default=True, action="store_true", help="Enable FP16 precision mode"
    )
