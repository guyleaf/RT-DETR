...
def slice_data(image_dir, dataset_json_path, output_dir, slice_size, overlap_ratio):
    try:
    ...
    tqdm.write(f" slicing for slice_size={slice_size}, overlap_ratio={overlap_ratio}")
    slice(
        image_dir=image_dir,
...
def main():
    ...
    parser.add_argument("--slice_size", type=int, default=500, help="slice_size")
    parser.add_argument(
